...
/*    R: 
        Em relação ao padrao feito com `tsc --init` percebemos as seguintes mudanças entre os arquivos da aula:
        - target: é uma versão desatualizada;
        - outDir: tem seu valor como "./";
        - rootDir: também tem seu valor como "./";

        Se entendi bem:
        - sourceMap gera o arquivo .map, que me faz questionar se precisa manter como true;
        - achei muito bacana a funcionalidade removeComments, para poder deixar o JS limpo;
        - o noImplicitAny me fez questionar se o manteria como true.
*/

console.log("E isso é tudo pessoal! :D")